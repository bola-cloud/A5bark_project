<div style="display: none" id="showObjectsCard" class="card card-body">
    ...
    <div class="my-1">
        ...
        <div class="my-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" disabled="disabled" class="form-control" id="show-en_title" placeholder="@lang('news.Ar Title')">
            </div>
        </div><!-- /.my-3 -->
        ...
        <div class="my-3 row">
            ...
            <div class="col-sm-10">
                <textarea disabled="disabled" class="form-control" id="show-location" rows="3" placeholder="@lang('news.Ar Content')"></textarea>
            </div>
        </div><!-- /.my-3 -->
        ...
        <div class="my-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" disabled="disabled" class="form-control" id="show-start_date" placeholder="@lang('news.En Head')">
            </div>
        </div><!-- /.my-3 -->
