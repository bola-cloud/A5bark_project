<div style="display: none" id="editObjectsCard" class="card card-body">
    ...
    <form action="/" id="editObjectForm" enctype="multipart/form-data">
        ...
        <div class="my-3 row">
            <label for="edit-news_category_id" class="col-sm-2 col-form-label">@lang('news.Category')</label>
            <div class="col-sm-10">
                <select class="form-control select2" id="edit-news_category_id">
                    <option value="">@lang('news.Select Category')</option>
                </select>
                <div style="padding: 5px 7px; display: none" id="edit-news_category_idErr" class="err-msg mt-2 alert alert-danger"></div>
            </div>
        </div><!-- /.my-3 -->
