<div style="display: none" id="showObjectsCard" class="card card-body">
    ...
    <div class="my-1">
        ...
        <div class="my-3 row">
            <label for="show-en_description" class="col-sm-2 col-form-label">@lang('news.En description')</label>
            <div class="col-sm-10">
                <textarea disabled="disabled" class="form-control" id="show-en_description" rows="3" placeholder="@lang('news.En description')"></textarea>
            </div>
        </div><!-- /.my-3 -->

        <div class="my-3 row">
            <label for="show-ar_description" class="col-sm-2 col-form-label">@lang('news.Ar description')</label>
            <div class="col-sm-10">
                <textarea disabled="disabled" class="form-control" id="show-ar_description" rows="3" placeholder="@lang('news.Ar description')"></textarea>
            </div>
        </div><!-- /.my-3 -->
